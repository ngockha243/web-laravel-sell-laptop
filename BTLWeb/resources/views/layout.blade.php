...
<head>
    ...
    <link href="{{asset('public/frontend/css/m1.css')}}" rel="stylesheet">
...
<header id="header">
    ...
    <div class="header-middle">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">  
                    <a href="{{URL::to('/trang-chu')}}"><img src="{{URL::to('/public/frontend/images/haha.png')}}" width="250px" height="100px"></img></a>
                </div>
                <div class="col-sm-8">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                        <img src="{{URL::to('/public/frontend/images/banner1.jpg')}}" class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                        <img src="{{URL::to('/public/frontend/images/banner2.jpg')}}"  class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                         <img src="{{URL::to('/public/frontend/images/banner3.jpg')}}" class="girl img-responsive" alt="" />
